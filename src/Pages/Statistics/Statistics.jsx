...
export default function Statistics(){
    return (
        <div className="statistics grid grid-cols-1 xxl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 auto-rows-[minmax(180px,auto)] gap-[20px] ">
            ...
            <div className="box4 col-span-1 sm:hidden hidden lg:grid row-span-3 p-[20px] rounded-[10px] border-solid border-[1px] border-[color:var(--soft-bg)]"><ChartPie {...pieData} /></div>
            ...
            <div className="box7 xl:grid lg:grid md:hidden sm:hidden hidden col-span-2 row-span-2 p-[20px] rounded-[10px] border-solid border-[1px] border-[color:var(--soft-bg)]"><ChartArea {...areaData} /> </div>
