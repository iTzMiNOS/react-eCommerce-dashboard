...
export default function Statistics(){
    return (
        <div className="statistics grid grid-flow-dense xxl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 sm:auto-rows-[minmax(120px,auto)] md:auto-rows-[minmax(180px,auto)] gap-[20px] ">
